...
export default function PostTile(props: { id: number; title: string; description: string; image: string; date: string }) {
	return (
		<Link href={"/post/" + props.id} className="group h-fit overflow-hidden cursor-pointer relative rounded-3xl xs:rounded-4xl aspect-[25/16]">
			<div
