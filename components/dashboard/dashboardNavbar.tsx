...
export default function DashboardNavbar(props: { session: SessionDataType }) {
	...
	return (
		<div
			className={`flex overflow-x-auto fixed w-full border-b-2 bg-white gap-x-1 sm:gap-x-2 flex-row lg:px-12 px-2 md:px-5 4xl:px-0 max-w-screen-4xl ${poppingsFont600.className}`}
		>
