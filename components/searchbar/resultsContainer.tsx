	...
	return (
		...
		>
			<div className="flex flex-col gap-y-1.5">
				<h3 className={`3xl:text-2xl ms-1 md:text-base text-xs xs:text-sm lg:text-xl poppinsFont700`}>Posty:</h3>
			...
			<div className="flex flex-col gap-y-1.5">
				<h3 className={`3xl:text-2xl ms-1 md:text-base text-xs xs:text-sm lg:text-xl poppinsFont700`}>Wydarzenia:</h3>
