		...
		return (
			<div className="flex w-full flex-col overflow-hidden lg:px-12 px-2 md:px-5 4xl:px-0 gap-y-3 sm:gap-y-5 xl:gap-y-7 3xl:gap-y-9 items-center">
				<div className="w-full">
					<h1
						className={`w-fit mx-auto text-2xl xs:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl xl:mt-9 mb-6 sm:mb-10 md:mb-12 lg:mb-16 xl:mb-20 poppinsFont700`}
					>
						{params.date == "today" ? "Dzisiejsze komunikaty" : formatDate(params.date)}
					</h1>
					<Link href="/radio" className={`hover:text-MainColor w-fit text-xl xs:text-sm lg:text-lg xl:text-xl 2xl:text-2xl poppinsFont700`}>
